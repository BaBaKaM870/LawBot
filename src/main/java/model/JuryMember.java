...
public class JuryMember {
    ...
    /**
     * Niveau de conviction que le suspect est coupable (0.0 à 1.0).
     * En dessous de 0.5 → penche pour l'innocence.
     * Au dessus de 0.5  → penche pour la culpabilité.
     */
    private double convictionLevel = 0.5;
